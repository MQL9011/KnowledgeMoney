...
def ocr_img(question_im, choices_im):

    # 切割题目和选项位置，左上角坐标和右下角坐标,自行测试分辨率

    # 冲顶大会
    # choices_im = image.crop((100, 900, 1050, 1530))
    # question_im = image.crop((75, 390, 1067, 989)) # iPhone X

    # 西瓜视频
    # choices_im = image.crop((100, 750, 1050, 1400))
    # question_im = image.crop((75, 350, 1067, 729)) # iPhone 7P

    # 芝士超人
    # question_im = image.crop((75, 350, 1067, 629))
